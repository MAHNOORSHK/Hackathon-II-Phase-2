        ...
        <div className="bg-white dark:bg-gray-900 rounded-2xl shadow-lg p-8 border border-gray-200 dark:border-gray-800 transition-colors">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600 dark:text-gray-400">
              Join Todo Pro and start managing tasks
            </p>
          </div>
          ...
          <div className="mt-6 text-center">
            <p className="text-gray-600 dark:text-gray-400">
              ...
              <Link href="/signin" className="text-indigo-600 dark:text-indigo-400 font-medium hover:text-indigo-700 dark:hover:text-indigo-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-indigo-500 rounded">
                Sign in
              </Link>
            </p>
          </div>
